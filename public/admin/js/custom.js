    ...
    $.ajax({
        ...
        success: (data) => {
           ...
           // let regionSelect = $('select[name="region_id"]');
            ...
            regionSelect.html('').append('<option value="">Choose</option>');
            $.each(data, function (k,v) {
                $('select[name="'+selectname+'"]').append(`<option value="${data[k].id}">${data[k].name}</option>`);
                //$('select[name="region_id"]').append(`<option value="${data[k].id}">${data[k].name}</option>`);
            })
        },
        error: function (data) {
          //
