            ...
            <div class="card-body">
                ...
                <form action="{{route('admin.report_type.store')}}" method="POST">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-sm-6">
                            <label class="font-weight-semibold @error('reorder') text-danger @enderror" for="reorder">{{__('admin.reorder')}}</label>
                            <div class="form-group-feedback form-group-feedback-right">
                                <input type="text" name="reorder" id="reorder" class="form-control @error('reorder') border-danger @enderror" placeholder="{{__('admin.reorder')}}" value="{{ old('reorder') }}">
                            </div>
                            @error('reorder')
                            <span class="form-text font-weight-semibold text-danger">{{ $message }}</span>
                            @enderror
