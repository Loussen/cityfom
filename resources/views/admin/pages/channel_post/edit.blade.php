            ...
            <div class="d-flex">
                <div class="breadcrumb">
                    <a href="{{ route($module_name.'.dashboard') }}" class="breadcrumb-item"><i class="icon-home2 mr-2"></i>
                        Home</a>
                    <a href="{{ route($module_name.'.channel_post.index') }}" class="breadcrumb-item">Channel Posts</a>
    ...
    <div class="content">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{route($module_name.'.channel_post.update', $channelPost->id)}}" method="POST"
