                    ...
                    <div class="form-row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="form-group-feedback form-group-feedback-right">
                                <input type="text" name="subject_en" id="subject_en"
                                       ...
                                       value="{{ old('subject_en', $generalMessage->subject_en) }}">
                            </div>
                            @error('subject_en')
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="form-group-feedback form-group-feedback-right">
                                <input type="text" name="subject_az" id="subject_az"
                                       ...
                                       value="{{ old('subject_az', $generalMessage->subject_az) }}">
                            </div>
                            @error('subject_az')
                            <span class="form-text font-weight-semibold text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="form-group-feedback form-group-feedback-right">
                                <input type="text" name="subject_es" id="subject_es"
                                       ...
                                       value="{{ old('subject_es', $generalMessage->subject_es) }}">
                            </div>
                            @error('subject_es')
                            <span class="form-text font-weight-semibold text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="form-group-feedback form-group-feedback-right">
                                <input type="text" name="subject_ru" id="subject_ru"
                                       ...
                                       value="{{ old('subject_ru', $generalMessage->subject_ru) }}">
                            </div>
                            @error('subject_ru')
                            <span class="form-text font-weight-semibold text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <textarea id="editor_en" rows="3" cols="3"
                                      ...
                                      name="content_en"
                                      placeholder="{{__('admin.content_es')}}">{!! old('content_en', $generalMessage->content_en) !!}</textarea>
                            @error('content_en')
                            <span class="form-text font-weight-semibold text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group col-sm-12">
                            ...
                            <textarea id="editor_az" rows="3" cols="3"
                                      ...
                                      name="content_az"
                                      placeholder="{{__('admin.content_az')}}">{{ old('content_az', $generalMessage->content_az) }}</textarea>
                            @error('content_az')
                            <span class="form-text font-weight-semibold text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group col-sm-12">
                            ...
                            <textarea id="editor_ru" rows="3" cols="3"
                                      ...
                                      name="content_ru"
                                      placeholder="{{__('admin.content_ru')}}">{{ old('content_ru', $generalMessage->content_ru) }}</textarea>
                            @error('content_ru')
                            <span class="form-text font-weight-semibold text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group col-sm-12">
                            ...
                            <textarea id="editor_es" rows="3" cols="3"
                                      class="form-control summernote-height @error('content_es') border-danger @enderror editor"
                                      name="content_es"
                                      placeholder="{{__('admin.content_es')}}">{{ old('content_es', $generalMessage->content_es) }}</textarea>
                            @error('content_es')
                            <span class="form-text font-weight-semibold text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group col-sm-6">
                            ...
                            <a href="javascript:void(0);" class="pop"><img
                                    src="{{ asset('/uploads/general_message/'.$generalMessage->image) }}"
